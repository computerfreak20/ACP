...
local scheme = {
	root = {	'PocoHud3 Main configuration',
		...
		showConvertedEnemy = {'num',1,{0,2},'Crimp health as percent if one has any','Verbose'},
		...
		minionLost  = {'num',2,{0,4},'Someone lost a crimp','ChatSend',nil,4},
		minionShot  = {'num',4,{0,4},'Someone shot a crimp','ChatSend',nil,4},
		...
		shieldColor = {'color','Red','color','Shield lost color, full amount',nil,nil,4},
		healthColor = {'color','Red','color','Health lost color, full amount',nil,nil,5},
		shieldColorDepleted = {'color','Red','color','Shield lost color, depleted',nil,nil,4},
		healthColorDepleted = {'color','Red','color','Health lost color, depleted',nil,nil,5},
