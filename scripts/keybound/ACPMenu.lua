...
ACPMenu:addGap('dentist_normal')
ACPMenu:addOption('dentist_normal', 'Hotline Miami: Day 1', { callback = HotlineMiamiDay1Normal, closeMenu = true } )
ACPMenu:addOption('dentist_normal', 'Hotline Miami: Day 2', { callback = HotlineMiamiDay2Normal, closeMenu = true } )
--[[ Hector Normal ]]--
...
ACPMenu:addGap('dentist_hard')
ACPMenu:addOption('dentist_hard', 'Hotline Miami Day 1', { callback = HotlineMiamiDay1Hard, closeMenu = true } )
ACPMenu:addOption('dentist_hard', 'Hotline Miami Day 2', { callback = HotlineMiamiDay2Hard, closeMenu = true } )
--[[ Hector Hard ]]--
...
ACPMenu:addGap('dentist_veryhard')
ACPMenu:addOption('dentist_veryhard', 'Hotline Miami: Day 1', { callback = HotlineMiamiDay1VeryHard, closeMenu = true } )
ACPMenu:addOption('dentist_veryhard', 'Hotline Miami: Day 2', { callback = HotlineMiamiDay2VeryHard, closeMenu = true } )
ACPMenu:addGap('dentist_veryhard')
ACPMenu:addOption('dentist_veryhard', 'Hotline Miami: Day 1 (Pro)', { callback = HotlineMiamiPRODay1VeryHard, closeMenu = true } )
ACPMenu:addOption('dentist_veryhard', 'Hotline Miami: Day 2 (Pro)', { callback = HotlineMiamiPRODay2VeryHard, closeMenu = true } )
--[[ Hector Very Hard ]]--
...
ACPMenu:addGap('dentist_overkill')
ACPMenu:addOption('dentist_overkill', 'Miami Hotline: Day 1', { callback = MiamiHotlineDay1OverKill, closeMenu = true } )
ACPMenu:addOption('dentist_overkill', 'Miami Hotline: Day 2', { callback = MiamiHotlineDay2OverKill, closeMenu = true } )
ACPMenu:addGap('dentist_overkill')
ACPMenu:addOption('dentist_overkill', 'Miami Hotline: Day 1 (Pro)', { callback = MiamiHotlinePRODay1OverKill, closeMenu = true } )
ACPMenu:addOption('dentist_overkill', 'Miami Hotline: Day 2 (pro)', { callback = MiamiHotlinePRODay2OverKill, closeMenu = true } )
--[[ Hector Overkill ]]--
...
ACPMenu:addOption('dentist_deathwish', 'Miami Hotline: Day 1', { callback = HotlineMiamiDay1DeathWish, closeMenu = true } )
ACPMenu:addOption('dentist_deathwish', 'Miami Hotline: Day 2', { callback = HotlineMiamiDay2DeathWish, closeMenu = true } )
ACPMenu:addGap('dentist_deathwish')
ACPMenu:addOption('dentist_deathwish', 'Miami Hotline: Day 1 (Pro)', { callback = HotlineMiamiPRODay1DeathWish, closeMenu = true } )
ACPMenu:addOption('dentist_deathwish', 'Miami Hotline: Day 2 (Pro)', { callback = HotlineMiamiPRODay2DeathWish, closeMenu = true } )
--[[ Hector Deathwish ]]--
